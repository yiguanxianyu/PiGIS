...
from PySide6.QtWidgets import QGraphicsItemGroup, QGraphicsItem, QGraphicsPathItem, QGraphicsSceneMouseEvent, \
...
class PiGraphicsItem(QGraphicsPathItem):
    def __init__(self, geometry: PiPolyline | PiPolygon | PiPoint, parent: QGraphicsItem, draw_control, pen: QPen,
                 brush: QBrush):
